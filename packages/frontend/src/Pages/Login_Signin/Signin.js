...
export default function Signin({wantsLogIn,setWantsLogIn}) {
      ...
      <form onSubmit={handleSubmit} className="w-2/3 h-3/4 flex flex-col justify-center gap-6 items-center ">
        <div className=" md:w-72 w-11/12   h-2/4 flex flex-col  justify-center gap-8 items-center ">
          <div className="relative w-full h-1/4 ">
            ...
            {nameValue ? "" : <span className="absolute top-2 md:top-2 lg:top-3 right-2 text-gray-400 text-3xl"><AiOutlineMail /></span>}
            {/* {isValidEmail ? ""
        ...
        <button type="submit" className="w-4/5 h-12 bg-blue-800 rounded-xl text-2xl capitalize  text-white">SIGNUP</button>
      </form>
